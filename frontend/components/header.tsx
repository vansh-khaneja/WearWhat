      ...
      <div className="container mx-auto px-4 lg:px-8 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a href="/signup">
              <Button className="bg-[#0095da] hover:bg-[#007ab8] text-white px-6 py-2.5 rounded-lg font-semibold shadow-sm hover:shadow-md hover:scale-105 active:scale-95 transition-all duration-200 focus:ring-[#0095da]">
                Start free
              </Button>
            </a>
          </div>
            ...
            <div className="flex flex-col gap-2 pt-4">
              ...
              <div className="pt-2 border-t border-gray-200 mt-2 space-y-2">
                ...
                <a 
                  ...
                  onClick={() => setIsMobileMenuOpen(false)}
                >
                  <Button className="w-full bg-[#0095da] hover:bg-[#007ab8] text-white px-6 py-2.5 rounded-lg font-semibold shadow-sm hover:shadow-md transition-all duration-200">
                    Start free
                  </Button>
                </a>
              </div>
